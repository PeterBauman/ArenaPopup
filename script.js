...
// Función para manejar el clic en cada subcírculo y mostrar la imagen correspondiente
function handleSubcircleClick(data) {
  // Mostrar una ventana emergente con la imagen del subcírculo
  const popup = window.open("", "popup", "width=400,height=400");
  popup.document.write(`<h1>Imagen del subcírculo</h1>`);
  popup.document.write(`<img src="${data.imagen}" alt="Imagen del subcírculo">`);
}
